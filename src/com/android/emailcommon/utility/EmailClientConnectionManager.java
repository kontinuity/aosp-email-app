...
public class EmailClientConnectionManager extends ThreadSafeClientConnManager {
    ...
    /**
     * A {@link javax.net.ssl.KeyManager} to track client certificate requests from servers.
     */
    private final TrackingKeyManager mTrackingKeyManager;

    /**
     * Not publicly instantiable except via {@link #newInstance(org.apache.http.params.HttpParams)}
     */
     ...
     * manager.
     * A {@link org.apache.http.conn.scheme.SchemeRegistry} is used to denote which client certificates to use for a given
     ...
     * manager.
     * @see #registerClientCert(android.content.Context, String, boolean)
     */

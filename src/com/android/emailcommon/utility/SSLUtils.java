...
public class SSLUtils {
    ...
    /**
     * A dummy {@link javax.net.ssl.KeyManager} which keeps track of the last time a server has requested
    ...
    public static class TrackingKeyManager extends StubKeyManager {
        ...
        /**
         * @return the last time that this {@link javax.net.ssl.KeyManager} detected a request by a server
    ...
    /**
     * A {@link javax.net.ssl.KeyManager} that reads uses credentials stored in the system {@link android.security.KeyChain}.
     */

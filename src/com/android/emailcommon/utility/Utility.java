...
public class Utility {
    ...
    /**
     * @return a {@link android.os.Handler} tied to the main thread.
     */
     ...
     *
     * Because we just use the {@link java.net.URI} class for validation, it'll accept some invalid
    ...
    /**
     * Cancel an {@link android.os.AsyncTask}.  If it's already running, it'll be interrupted.
     */
    ...
    /**
     * Cancel an {@link android.os.AsyncTask}.
     *
    ...
    /**
     * Interface used in {@link #createUniqueFile} instead of {@link java.io.File#createNewFile()} to make
     * it testable.
     */
    ...
    /**
     * Append a bold span to a {@link android.text.SpannableStringBuilder}.
     */

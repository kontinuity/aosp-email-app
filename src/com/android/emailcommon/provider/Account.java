...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
    ...
    /**
     * @return {@link android.net.Uri} to this {@link com.android.emailcommon.provider.Account} in the
    ...
    /**
     * @return {@link android.net.Uri} to an {@link com.android.emailcommon.provider.Account} with a {@code uuid}.
     */
    ...
    /**
     * Parse {@link android.net.Uri} in the {@code content://com.android.email.provider/account/ID} format
     * where ID = account id (used on Eclair, Android 2.0-2.1) or UUID, and return _id of
     * the {@link com.android.emailcommon.provider.Account} associated with it.
     *
     * @param context context to access DB
     * @param uri URI of interest
     * @return _id of the {@link com.android.emailcommon.provider.Account} associated with ID, or -1 if none found.
     */

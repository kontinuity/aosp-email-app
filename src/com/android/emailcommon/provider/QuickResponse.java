...
public final class QuickResponse extends EmailContent
    ...
    /**
     * @see EmailContent#restore(android.database.Cursor)
     */
    @Override
    ...
    /**
     * @see EmailContent#toContentValues()
     */
    @Override
     ...
     * Implements Parcelable
     */
    public static final Creator<QuickResponse> CREATOR
            = new Creator<QuickResponse>() {
        @Override
